console.log("hiiiiiiii updated js");
...
function showRows() {
    ...
    var flowers = document.getElementByClassName("user-flower");
    var counter = 0;
    rows.forEach((row) => {
        
        var current_flower = flowers[counter];

        const message = document.createElement("div");
        message.innerText = row.fields.Responses;
        flower[counter].appendChild(message);
        flower[counter].style.display = "block";
